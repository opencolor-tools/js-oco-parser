...
class Color {
  ...
  get(name) {
    // TODO: Decide if deep access into the color value object is the right choice.
    // it feels weird to have to call get('rgb').value instead of get('rgb').
