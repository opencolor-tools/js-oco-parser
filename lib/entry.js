  ...
  _createClass(Entry, [{
    ...
    value: function addChildren(children) {
      ...
      children.forEach(function (child) {
        ...
        if (type === 'Metadata') {
          _this.metadata[child.name] = child.value;
          ...
          if ('undefined' !== typeof _this.childKeys[child.name]) {
            // name collision. just overwrite as yaml would probably do.
            _this.children[_this.childKeys[child.name]] = child;
          } else {
            var newIndex = _this.children.length;
            _this.children.push(child);
            _this.childKeys[child.name] = newIndex;
          }
        }
        child.parent = _this;
      });
    ...
    value: function resolveReferences() {
      ...
      Object.keys(this.metadata).forEach(function (key) {
        _this2.resolveChild(_this2.metadata[key]);
      });
